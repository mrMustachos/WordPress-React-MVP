...
const Archive = props => {
  ...
  const pagePart = props.match.params;
  console.log(Object.keys(pagePart).join('') || 'blog'); // let { term, getAllPosts } = useContext(PageContext);
  // getAllPosts();
...
//# sourceMappingURL=main.c7372821.chunk.js.map