...
class PageProvider extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(...args) {
    ...
    this.getNumPages = async type => {
      ...
      const perPage = this.getpPerPage(type);
      const url = "".concat(baseUrl).concat(type).concat(perPage);
      const allTest = await axios__WEBPACK_IMPORTED_MODULE_1___default()(url, wpFetchHeaders);
      console.log(allTest);
...
//# sourceMappingURL=main.e394e007.chunk.js.map