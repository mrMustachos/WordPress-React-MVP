...
class PageProvider extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(...args) {
    ...
    this.componentDidMount = () => {
      ...
      .then(() => this.fetchData()).then(numPages => this.collectAllData(numPages, 'pages')).then(data => this.updateState(data, 'pages')).catch(err => console.error('err fetching page data', err));
    };
...
//# sourceMappingURL=main.1221cb85.chunk.js.map