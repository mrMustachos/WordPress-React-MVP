...
const BlogPage = ({
  ...
  let existEnd2End = content && content.length - 1 === endIdx;
  let fullLoad = content && content.length === total;
  let curPage = currentPage;
  let totalPages = Math.ceil(total / perSet); // const chunk = (array, size) => {
  // 	let chunked = [];
  // 	let idx = 0;
...
//# sourceMappingURL=main.645d34bc.chunk.js.map