...
class PageProvider extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(...args) {
    ...
    this.componentDidMount = () => {
      this.unsubscribeFromPages = this.getFrontPage().then(() => this.getNumPages('pages')).then(numPages => this.fetchData(numPages, 'pages')).then(data => this.updateState(data, 'pages')).catch(err => console.error('err fetching page data', err)); // this.unsubscribeFromPosts = this.getNumPages('posts')
      // 	.then((numPosts) => this.fetchData(numPosts, 'posts'))
      // 	.then((data) => this.updateState(data, 'posts'))
...
const Page = props => {
  ...
  const pgObj = all.pgObj;
  const getAllPosts = all.getAllPosts;

  const testIt = () => {
    getAllPosts();
  };

  console.log(Object(react__WEBPACK_IMPORTED_MODULE_0__["useContext"])(_providers_PageProvider_jsx__WEBPACK_IMPORTED_MODULE_1__["PageContext"]));
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], {
    ...
    __self: undefined
  }), pagePicker(), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
    onClick: () => testIt(),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 70
    ...
    __self: undefined
  }, "get them"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_partials_Foot__WEBPACK_IMPORTED_MODULE_3__["default"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 71
    },
...
//# sourceMappingURL=main.893c2471.chunk.js.map