...
class PageProvider extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(...args) {
    ...
    this.handlePostArr = data => {
      ...
      let result;
      let currPostArr = JSON.stringify(...postArr);
      let incomingData = JSON.stringify(...data); // console.log(currPostArr.includes(incomingData));

      console.log(currPostArr); // console.log(typeof incomingData);
...
//# sourceMappingURL=main.230ba335.chunk.js.map