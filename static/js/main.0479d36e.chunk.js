...
class PageProvider extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(...args) {
    ...
    this.getNumPages = async (type = 'pages') => {
    ...
    this.fetchPages = async (numPages, type = 'pages') => {
    ...
    this.componentDidMount = () => {
      ...
      this.unsubscribeFromPosts = this.getNumPages('posts').then(numPosts => this.fetchPages(numPosts, 'posts')).catch(err => console.error('err fetching post data', err));
    };
...
/* harmony import */ var _providers_PageProvider_jsx__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../providers/PageProvider.jsx */ "./src/providers/PageProvider.jsx");
...
const Archive = props => {
  const _useContext = Object(react__WEBPACK_IMPORTED_MODULE_0__["useContext"])(_providers_PageProvider_jsx__WEBPACK_IMPORTED_MODULE_3__["PageContext"]),
        postArr = _useContext.postArr;

  let pageTitle = props.match.path === '/search/:term' ? 'Search Results' : '';
  console.log(props.match.path); // return (
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    __self: undefined
  }, pageTitle)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_partials_Foot__WEBPACK_IMPORTED_MODULE_2__["default"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 38
    },
...
//# sourceMappingURL=main.0479d36e.chunk.js.map