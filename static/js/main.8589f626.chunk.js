...
class PageProvider extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  setDataPaths(responce) {
    ...
    switch (restType) {
      case 'posts':
        this.setState({
          totalPosts: makeNum(headers['x-wp-total']),
          postArr: data
        });
        break;
      ...
      case 'search':
        this.setState({
          totalSearch: makeNum(headers['x-wp-total']),
          searchArr: data
        });
        break;
      ...
      default:
        this.setState({
          totalPages: makeNum(headers['x-wp-total'])
        });
        pathData = makeNum(headers['x-wp-totalpages']);
        break;
    }
...
//# sourceMappingURL=main.8589f626.chunk.js.map