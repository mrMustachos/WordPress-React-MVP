...
class PageProvider extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(...args) {
    ...
    this.componentDidMount = () => {
      this.unsubscribeFromPages = this.getFrontPage().then(() => this.getNumPages('pages')).then(numPages => this.fetchPages(numPages)).catch(err => console.error('err fetching page data', err));
...
//# sourceMappingURL=main.6ccfc1d0.chunk.js.map