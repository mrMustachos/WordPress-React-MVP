...
const Archive = props => {
  const _useContext = Object(react__WEBPACK_IMPORTED_MODULE_0__["useContext"])(_providers_PageProvider_jsx__WEBPACK_IMPORTED_MODULE_5__["PageContext"]),
        postArr = _useContext.postArr;

  let pageTitle = props.match.path === '/search/:term' ? 'Search Results' : ''; // return (
...
//# sourceMappingURL=main.e684184d.chunk.js.map