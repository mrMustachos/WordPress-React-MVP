...
class PageProvider extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(...args) {
    ...
    this.state = {
      ...
      post_currPage: 1,
      page_currPage: 1,
      post_totalPages: null,
      page_totalPages: null,
      frontPageId: null,
    ...
    this.fetchData = async type => {
      ...
      return this.setDataPaths(responce, type);
    };

    this.collectAllData = async (numPages, type) => {
      const _this$wpInfo4 = this.wpInfo,
            baseUrl = _this$wpInfo4.baseUrl,
            wpFetchHeaders = _this$wpInfo4.wpFetchHeaders;
      const perPage = this.getPerPage(type);
      const dataArr = [];
    ...
    this.getFrontPage = async () => {
      const _this$wpInfo5 = this.wpInfo,
            baseUrl = _this$wpInfo5.baseUrl,
            wpFetchHeaders = _this$wpInfo5.wpFetchHeaders;
  ...
  getPerPage(type) {
    const _this$wpInfo6 = this.wpInfo,
          post_perPage = _this$wpInfo6.post_perPage,
          page_perPage = _this$wpInfo6.page_perPage;
    let contentType;
...
//# sourceMappingURL=main.55bbe50d.chunk.js.map