...
class Archive extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(...args) {
    ...
    this.componentDidMount = () => {// this.unsubscribeFromComments = this.commentsRef.onSnapshot((snapshot) => {
      // 	const comments = snapshot.docs.map(collectIdsAndDocs);
      // 	this.setState({ comments });
      // });
    };

    this.componentWillUnmount = () => {// this.unsubscribeFromComments();
    };
  }

  // unsubscribeFromComments = null;
  all() {
    return Object(react__WEBPACK_IMPORTED_MODULE_0__["useContext"])(_providers_PageProvider_jsx__WEBPACK_IMPORTED_MODULE_1__["PageContext"]);
  }
  ...
  render() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      ...
      __self: this
    }, pageTitle)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_partials_Foot__WEBPACK_IMPORTED_MODULE_3__["default"], {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 59
      },
...
//# sourceMappingURL=main.8deca996.chunk.js.map