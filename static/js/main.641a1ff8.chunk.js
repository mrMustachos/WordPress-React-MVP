...
const Archive = props => {
  let _useContext = Object(react__WEBPACK_IMPORTED_MODULE_0__["useContext"])(_providers_PageProvider_jsx__WEBPACK_IMPORTED_MODULE_1__["PageContext"]),
      term = _useContext.term; // const pageSlug = props.match.params.slug


  console.log(props.match.params || 'blog'); // let { term, getAllPosts } = useContext(PageContext);
  // getAllPosts();
...
//# sourceMappingURL=main.641a1ff8.chunk.js.map