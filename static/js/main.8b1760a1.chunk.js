...
const BlogPage = ({
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], {
    ...
    // let startPoint = startIdx === 0 ? startIdx : (startIdx - 1);
    // console.log('startIdx: ', startIdx);
    // console.log('startIdx + (perSet - 1): ', startPoint + (perSet - 1));
    // console.log('idx: ', idx);
    // let renderCheck = idx >= startIdx && idx <= startPoint + (perSet - 1);
    // console.log(renderCheck);
    // return renderCheck ? <ThePost key={ post.id } data={ post }  idx={ idx } /> : '';
...
//# sourceMappingURL=main.8b1760a1.chunk.js.map