...
const Pagination = ({
  ...
  console.log('all: ', all); // let prevBtn =  React.createRef(); 
  // let nextBtn =  React.createRef(); 

  let curPage = all.currentPage;
  let totalPages = Math.ceil(totalCount / perSet);
  console.log('curPage: ', curPage);
  console.log('totalPages: ', totalPages); // useEffect(() => {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", {
    ...
    __self: undefined
  }, "show me more shit please!"); // return (
  ...
  // 			<span dangerouslySetInnerHTML={ {__html: totalPages()} }></span>
  // 		</div>
  // 	</div>
  // );
...
//# sourceMappingURL=main.872c897f.chunk.js.map