...
const Archive = props => {
  ...
  const archiveNeedsPagination = () => {
    ...
    switch (contentType) {
      case 'blog':
        result = totalPosts > postArr.length ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Pagination, {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 48
          },
      ...
      default:
        // 404
        result = totalSearch > searchArr.length ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Pagination, {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 54
          },
...
//# sourceMappingURL=main.1ba4c352.chunk.js.map