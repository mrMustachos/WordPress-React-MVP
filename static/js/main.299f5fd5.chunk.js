...
class PageProvider extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  setDataPaths(responce) {
    const _this$state4 = this.state,
          restType = _this$state4.restType,
          postArr = _this$state4.postArr;
    ...
    switch (restType) {
      case 'posts':
        let allPostsData = !postArr ? data : [...postArr].concat(data);
        this.setState({
...
/* harmony import */ var _partials_Pagination_jsx__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../partials/Pagination.jsx */ "./src/partials/Pagination.jsx");
...
const Archive = props => {
  ...
  const archiveNeedsPagination = () => {
    ...
    switch (contentType) {
      case 'blog':
        result = totalPosts > postArr.length ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_partials_Pagination_jsx__WEBPACK_IMPORTED_MODULE_7__["default"], {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 49
          },
      ...
      default:
        // 404
        result = totalSearch > searchArr.length ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_partials_Pagination_jsx__WEBPACK_IMPORTED_MODULE_7__["default"], {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 55
          },
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    __self: undefined
  }, archiveContentPicker()), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_partials_Foot__WEBPACK_IMPORTED_MODULE_3__["default"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 68
    },
...
//# sourceMappingURL=main.299f5fd5.chunk.js.map