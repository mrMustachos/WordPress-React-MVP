...
class PageProvider extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  getAllPosts() {
    this.unsubscribeFromPosts = this.getNumPages('posts').then(numPosts => this.fetchAllData(numPosts, 'posts')).then(data => this.updateState(data, 'posts')).catch(err => console.error('err fetching post data', err));
  }
...
//# sourceMappingURL=main.00a389ae.chunk.js.map