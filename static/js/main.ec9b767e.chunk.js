...
class PageProvider extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(...args) {
    ...
    this.componentDidMount = () => {
      ...
      this.unsubscribeFromPosts = this.getNumPages('pages').then(numPosts => this.fetchData(numPosts, 'pages')); // 	.catch((err) => console.error('err fetching post data', err));
    };
...
//# sourceMappingURL=main.ec9b767e.chunk.js.map