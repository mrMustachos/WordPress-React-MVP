  ...
  constructor(...args) {
    ...
    this.componentDidMount = () => {
      ...
      if (pathname === pathname.startsWith('/blog')) {
        this.getAllPosts(); // } else if (pathname.startsWith('/blog/')) {
        // 	let slug = pathname.replace('/blog/', '');
        // 	console.log(`get blog post with slug: ${slug}`);
...
//# sourceMappingURL=main.3fa47013.chunk.js.map