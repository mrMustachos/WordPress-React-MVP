...
const BlogPage = ({
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], {
    ...
    let renderCheck = idx >= startIdx && idx <= startIdx + (perSet - 1);
    console.log(renderCheck);
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_partials_ThePost_js__WEBPACK_IMPORTED_MODULE_2__["default"], {
      key: post.id,
      data: post,
      idx: idx,
      __source: {
...
//# sourceMappingURL=main.71f5d3a1.chunk.js.map