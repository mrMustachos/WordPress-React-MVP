...
class PageProvider extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(...args) {
    ...
    this.collectAllData = async numPages => {
      // const { baseUrl, wpFetchHeaders } = this.wpInfo;
      // const perPage = this.getPerPage(restType);
      const bwpFetchHeaders = this.wpInfo.bwpFetchHeaders;
      const restType = this.state.restType;
      const dataArr = [];

      for (let pg = 1; pg <= numPages; pg += 1) {
        // const url = `${baseUrl}${restType}${perPage}&page=${pg}`;
  ...
  getPerPage(type) {
    const _this$wpInfo2 = this.wpInfo,
          post_perPage = _this$wpInfo2.post_perPage,
          page_perPage = _this$wpInfo2.page_perPage;
    let contentType;
...
//# sourceMappingURL=main.c282567d.chunk.js.map