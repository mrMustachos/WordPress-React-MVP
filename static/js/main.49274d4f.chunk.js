...
class PageProvider extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  setDataPaths(responce) {
    ...
    switch (restType) {
      ...
      case 'search':
        this.setState({
          totalSearch: parseInt(headers['x-wp-total'], 10),
          searchArr: data
        });
        break;
      ...
      default:
        this.setState({
          totalPages: parseInt(headers['x-wp-total'], 10)
        });
        pathData = parseInt(headers['x-wp-totalpages'], 10);
        break;
    }
...
//# sourceMappingURL=main.49274d4f.chunk.js.map