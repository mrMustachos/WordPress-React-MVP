...
class PageProvider extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(...args) {
    ...
    this.handlePostArr = data => {
      ...
      let makeStr = res => res.reduce((acc, curr) => acc += JSON.stringify(curr), '');

      let result; // let nextUp = ...data;
      // let currPostArr = JSON.stringify(curr);
      // let incomingData = JSON.stringify(nextUp);
      // console.log(currPostArr.includes(incomingData));
      // let incomingData = makeStr(data);
      // console.log(incomingData);
      // console.log(typeof incomingData);
      // console.log(currPostArr === incomingData);
      ...
      if (!postArr) {
        ...
        let incomingData = makeStr(data);
        let currData = makeStr(postArr);
        console.log(currData.includes(incomingData));
  ...
  nextClicked(type) {
    const _this$state4 = this.state,
          ...
          endIdx = _this$state4.endIdx,
          perPost = _this$state4.perPost,
          prePage = _this$state4.prePage;
    let newPage = currentPage + 1; // let checkOffset = startIdx === 0 ? startIdx : (startIdx - 1);
    ...
    this.setState({
      currentPage: newPage // startIdx : newStart,
      // endIdx: newEnd,
  ...
  previousClicked(type) {
    const _this$state5 = this.state,
          ...
          endIdx = _this$state5.endIdx,
          perPost = _this$state5.perPost,
          prePage = _this$state5.prePage;
    let newPage = currentPage - 1; // let newStart = type === 'posts' ? (startIdx - perPost) : (startIdx - prePage);
...
//# sourceMappingURL=main.8e560b81.chunk.js.map