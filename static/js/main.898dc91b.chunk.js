...
class PageProvider extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(...args) {
    ...
    this.handlePostArr = data => {
      ...
      let result; // console.log('postArr: ', JSON.stringify(postArr));
      // console.log('data: ', JSON.stringify(data));

      console.log('compair: ', JSON.stringify(postArr) === JSON.stringify(data));
...
const Archive = props => {
  ...
  const archiveNeedsPagination = () => {
    ...
    switch (contentType) {
      case 'blog':
        result = !!totalPosts && totalPosts > postArr.length ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_partials_Pagination_jsx__WEBPACK_IMPORTED_MODULE_4__["default"], {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 49
          },
      ...
      default:
        // 404
        result = !!totalSearch && totalSearch > searchArr.length ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_partials_Pagination_jsx__WEBPACK_IMPORTED_MODULE_4__["default"], {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 55
          },
...
//# sourceMappingURL=main.898dc91b.chunk.js.map