  ...
  if (context.appError) {
    ...
    if (pos.length === 0) {
      ...
      results = pos.map((item, i, all) => {
        let prevNext = {
          prevSlug: !!all[i - 1] ? all[i - 1].slug : null,
          nextSlug: !!all[i + 1] ? all[i + 1].slug : null // let prevPost = {
          // 	slug: !!(all[i - 1]) ? all[i - 1].slug : null,
          // 	count: i + 1
          // 	nextSlug: !!(all[i + 1]) ? all[i + 1].slug : null
          // };
          // let nextPost = {
          // 	slug: !!(all[i + 1]) ? all[i + 1].slug : null
          // 	count: i + 1
...
//# sourceMappingURL=main.aa74b91e.chunk.js.map