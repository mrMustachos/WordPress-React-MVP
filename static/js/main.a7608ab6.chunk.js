...
class PageProvider extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(...args) {
    ...
    this.fetchData = async () => {
      ...
      const restType = this.state.restType; // const perPage = this.getPerPage(restType);
  ...
  getPerPage(type) {
    const _this$wpInfo3 = this.wpInfo,
          post_perPage = _this$wpInfo3.post_perPage,
          page_perPage = _this$wpInfo3.page_perPage;
    let contentType;
...
//# sourceMappingURL=main.a7608ab6.chunk.js.map