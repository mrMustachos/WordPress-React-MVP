...
const BlogPage = ({
  ...
  let curPage = currentPage; // let totalPages = Math.ceil((totalCount / perSet));

  let existEnd2End = content && content.length === curPage * perSet;
  let fullLoad = content && content.length === totalCount; // const chunk = (array, size) => {
  // 	let chunked = [];
  // 	let idx = 0;
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], {
    ...
    __self: undefined
  }, fullLoad || existEnd2End ? content.map((post, idx) => {
    // console.log('startIdx: ', startIdx);
    // console.log('endIdx: ', endIdx);
    let renderCheck = idx >= startIdx && idx <= endIdx;
    return renderCheck ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_partials_ThePost_js__WEBPACK_IMPORTED_MODULE_3__["default"], {
      key: post.id,
      data: post,
      idx: idx,
      __source: {
      ...
      __self: undefined
    }) : ''; // return <ThePost key={ post.id } data={ post }  idx={ idx } />;
...
//# sourceMappingURL=main.7bd4c6c8.chunk.js.map