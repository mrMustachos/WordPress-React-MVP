...
const BlogPage = ({
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], {
    ...
    let renderCheck = idx >= startIdx && idx <= endIdx; // console.log(renderCheck);
...
class PageProvider extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  nextClicked(type) {
    ...
    let newEnd = (perPost - 1) * newPage;
    let newStart = startIdx + perPost;
    this.setState({
      currentPage: newPage,
      startIdx: newStart,
      endIdx: newEnd
...
//# sourceMappingURL=main.eb818d70.chunk.js.map