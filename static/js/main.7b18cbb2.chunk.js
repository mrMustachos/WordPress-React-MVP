...
const Archive = props => {
  let _useContext = Object(react__WEBPACK_IMPORTED_MODULE_0__["useContext"])(_providers_PageProvider_jsx__WEBPACK_IMPORTED_MODULE_1__["PageContext"]),
      term = _useContext.term; // let { term, getAllPosts } = useContext(PageContext);
  // getAllPosts();
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    __self: undefined
  }, props.match.path === '/search/:term' ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 21
    },
    __self: undefined
  }, "Search Results: ", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("em", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 21
    },
    __self: undefined
  }, term)) : ''), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_partials_Foot__WEBPACK_IMPORTED_MODULE_3__["default"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 25
    },
...
// 	};
// 	render() {
// 		let pageTitle = this.props.match.path === '/search/:term' ? 'Search Results' : '';
// 		return (
...
//# sourceMappingURL=main.7b18cbb2.chunk.js.map