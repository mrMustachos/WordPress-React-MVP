...
const BlogPage = ({
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], {
    ...
    __self: undefined
  }, content ? content.map((post, idx) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_partials_ThePost_js__WEBPACK_IMPORTED_MODULE_2__["default"], {
    key: post.id,
    data: post,
    idx: idx,
    __source: {
...
class PageProvider extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  buildUrl() {
    ...
    switch (restType) {
      ...
      case 'posts':
        console.log("".concat(restType).concat(perPage, "&page=").concat(currentPage));
...
//# sourceMappingURL=main.3b9c80f0.chunk.js.map