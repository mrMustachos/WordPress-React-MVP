...
const Page = props => {
  ...
  const pgObj = all.pgObj,
        getAllPosts = all.getAllPosts; // const testIt = () => {
  // 	getAllPosts();
  // 	// <button onClick={ () => testIt() }>get them</button>
  // 	console.log(all);
  // }
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], {
    ...
    onClick: getAllPosts.then(() => console.log(all)),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 72
    },
...
//# sourceMappingURL=main.b404cc66.chunk.js.map