...
class PageProvider extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(...args) {
    ...
    this.fetchAllData = async (numPages, type) => {
    ...
    this.componentDidMount = () => {
      this.unsubscribeFromPages = this.getFrontPage().then(() => this.getNumPages('pages')).then(numPages => this.fetchAllData(numPages, 'pages')).then(data => this.updateState(data, 'pages')).catch(err => console.error('err fetching page data', err));
    };
  ...
  getAllPosts() {
    this.getNumPages('posts').then(numPosts => this.fetchAllData(numPosts, 'posts')).then(data => this.updateState(data, 'posts')).catch(err => console.error('err fetching post data', err));
  }
...
//# sourceMappingURL=main.412aad1e.chunk.js.map