...
class PageProvider extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(...args) {
    ...
    this.componentDidMount = () => {
      this.unsubscribeFromPages = this.getFrontPage().then(() => this.getNumPages()).then(numPages => this.fetchPages(numPages)).catch(err => console.error('err fetching page data', err)); // this.unsubscribeFromPosts = this.getNumPages('posts')
      // 	.then((numPosts) => this.fetchPages(numPosts, 'posts'))
...
//# sourceMappingURL=main.c761007c.chunk.js.map